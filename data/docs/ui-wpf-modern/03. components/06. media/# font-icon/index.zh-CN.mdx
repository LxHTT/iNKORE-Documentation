...
- **继承**: [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → (...) → [FrameworkElement](https://learn.microsoft.com/en-us/dotnet/api/system.windows.frameworkelement) → [IconElement](.) → [FontIcon](.)
...
- `SegoeFluentIcons`：来自 Microsoft 的 [Segoe Fluent Icons Family](https://learn.microsoft.com/en-us/windows/apps/design/style/segoe-fluent-icons-font)；
