...
{
    if (sender is MenuItem menuItem && menuItem.Tag is string alignment)
    {
        switch (alignment)
        {
            case "left":
                TextBox_Text.TextAlignment = TextAlignment.Left;
                break;
            case "center":
                TextBox_Text.TextAlignment = TextAlignment.Center;
                break;
            case "right":
                TextBox_Text.TextAlignment = TextAlignment.Right;
                break;
        }
    }
}
